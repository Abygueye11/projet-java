...
public class Employe extends Personne {
    ...
    private static String generateRandomName() {
        // Ajoutez la logique pour générer une chaîne aléatoire de longueur 10
        return "RandomName"; // Remplacez ceci par votre logique
    }
    ...
    public static Employe creerEmploye(String nom, double salaire) {
        ...
        return new Employe(generateRandomName(), new Date(), 0.0, salaire, "Inconnu");
    }
    ...
    public static void trierEmployes() {
        Collections.sort(employeCollection, (e1, e2) -> e1.nom.compareTo(e2.nom));
    }
